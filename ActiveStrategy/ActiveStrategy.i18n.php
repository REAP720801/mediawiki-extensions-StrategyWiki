...
$messages['ru'] = array(
	...
	'active-strategy-intro' => 'Количество правок страниц комиссий за {{PLURAL:$1|последний $1 день|последние $1 дней|последние $1 дня}}.', # Fuzzy
	'nedits' => '$1 {{PLURAL:$1|правка|правок|правки}}', # Fuzzy
);
